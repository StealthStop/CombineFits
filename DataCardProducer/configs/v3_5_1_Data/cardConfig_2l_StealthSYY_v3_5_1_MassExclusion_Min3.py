...
obs_hist  = "h_njets_10incl_$MODELS_$CHANNEL_ABCD"
obs_start = 6
obs_end   = 10
...
observed["QCD"] = {
        "path"      : "$YEAR_TT_QCD_Syst_$MODELS_$CHANNEL_0.48_0.48.root",
        "sys"       : 1.0, 
...
sys_path  = "$YEAR_TT_QCD_Syst_$MODELS_$CHANNEL_0.48_0.48.root" # including TT and QCD
...
var_list  = ["JEC", "JER", "btg", "lep", "pdf", "prf", "pu", "scl", "isr", "fsr"] 
...
for var in var_list:
    for proc in var_proc:
        ...
        systematics["{}_{}".format(proc, var)] = {
            ...
            "upHist"    : "h_njets_10incl_$MODELS_$CHANNEL_ABCD_{}{}".format(var, up),
            "downHist"  : "h_njets_10incl_$MODELS_$CHANNEL_ABCD_{}{}".format(var, down),
            "nomHist"   : "h_njets_10incl_$MODELS_$CHANNEL_ABCD".format(var),
            "distr"     : "lnN",
            "proc"      : proc,
            "type"      : "sys",
            "start"     : sys_start, 
