...
observed["QCD"] = {
        "path"      : "$YEAR_TT_QCD_Syst_$MODELS_$CHANNEL_0.54_0.56.root",
        "sys"       : 1.0, 
...
sys_path  = "$YEAR_TT_QCD_Syst_$MODELS_$CHANNEL_0.54_0.56.root" # including TT and QCD
