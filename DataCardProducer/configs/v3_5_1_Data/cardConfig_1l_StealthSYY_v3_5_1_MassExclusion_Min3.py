...
#     "hist"      : "Name of Njets histogram to load event counts from (h_njets_11incl_1l_ABCD)",
...
#     "end"       : Ending Njets bin in histogram (11),
# }
...
observed["QCD"] = {
        "path"      : "$YEAR_TT_QCD_Syst_$MODELS_$CHANNEL_0.68_0.82.root",
        "sys"       : 1.0, 
...
sys_path  = "$YEAR_TT_QCD_Syst_$MODELS_$CHANNEL_0.68_0.82.root" # including TT and QCD
...
systematics = {
    ...
    #"QCD_Syst" : {
    #    "path"  : sys_path,
    #    "hist"  : "Run2UL_QCDCR_syst_1l", # need to put correct histo here
    #    "distr" : "lnN",
    #    "proc"  : "QCD",
    #    "type"  : sys_type,
    #    "start" : sys_start,
