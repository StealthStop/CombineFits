...
obs_hist  = "h_njets_11incl_$MODELS_$CHANNEL_ABCD_$DISC1_$DISC2"
obs_start = 6
obs_end   = 11
...
for var in var_list:
    for proc in var_proc:
        ...
        systematics["{}_{}".format(proc, var)] = {
            ...
            "upHist"    : "h_njets_11incl_$MODELS_$CHANNEL_ABCD_{}{}_$DISC1_$DISC2".format(var, up),
            "downHist"  : "h_njets_11incl_$MODELS_$CHANNEL_ABCD_{}{}_$DISC1_$DISC2".format(var, down),
            "nomHist"   : "h_njets_11incl_$MODELS_$CHANNEL_ABCD_$DISC1_$DISC2".format(var),
            "distr"     : "lnN",
            "proc"      : proc,
            "type"      : "sys",
            "start"     : sys_start, 
